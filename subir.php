<?php
// Nombre de la carpeta a crear o recuperar del almacenamiento local
$carpetaNombre = isset($_GET['nombre']) ? $_GET['nombre'] : '';
// Nombre de la carpeta en el almacenamiento local
$carpetaNombreLocal = isset($_COOKIE['carpetaNombre']) ? $_COOKIE['carpetaNombre'] : '';

// Si no hay nombre de carpeta en la URL, utiliza el almacenado localmente
if (empty($carpetaNombre) && !empty($carpetaNombreLocal)) {
